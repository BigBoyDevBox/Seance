...
| SSH | **dartssh2 3.0.2, exactly pinned** (pure Dart, MIT) | Password + key auth (Ed25519/ECDSA/RSA), keyboard-interactive, PTY + resize, keepalives, port forwarding, and jump-host chaining; 3.0.2 owns every pipelined read completion during cancellation, preventing detached SFTP abort errors during teardown |
