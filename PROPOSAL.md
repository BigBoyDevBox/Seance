...
| SSH | **[dartssh2 3.0.2](https://github.com/vicajilau/dartssh2/pull/200), exactly pinned** (pure Dart, MIT) | Password + key auth (Ed25519/ECDSA/RSA), keyboard-interactive, PTY + resize, keepalives, port forwarding, and jump-host chaining; 3.0.2 attaches completion and error handlers to every scheduled pipelined read, keeping late SFTP abort errors owned when the consumer cancels during teardown |
